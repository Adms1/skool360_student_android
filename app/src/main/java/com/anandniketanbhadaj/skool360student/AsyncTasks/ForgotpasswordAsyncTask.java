...
public class ForgotpasswordAsyncTask extends AsyncTask<Void, Void,ExamModel> {
    ...
    protected ExamModel doInBackground(Void... params) {
        ...
        try {
            responseString = WebServicesCall.RunScript(AppConfiguration.getUrl(AppConfiguration.ForgetIDPassword), param);
            Gson gson = new Gson();
