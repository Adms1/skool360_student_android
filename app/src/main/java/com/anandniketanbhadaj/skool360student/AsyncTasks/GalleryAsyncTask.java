...
public class GalleryAsyncTask extends AsyncTask<Void, Void,ExamModel> {
    HashMap<String, String> param = new HashMap<String, String>();

    public GalleryAsyncTask(HashMap<String, String> param) {
        this.param = param;
    }
    ...
    protected ExamModel doInBackground(Void... params) {
        ...
        try {
            responseString = WebServicesCall.RunScript(AppConfiguration.getUrl(AppConfiguration.GetGallery), param);
